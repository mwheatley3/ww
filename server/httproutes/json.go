...
// Respond lets the caller chose an arbitrary HTTP status code with a JSON body
func (j *JSONResponder) Respond(data interface{}, code int) {
	j.write(&JSONResponse{Data: data}, code)
}
